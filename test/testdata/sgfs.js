...
testdata.sgfs = {
  ...
  gggEasy44:
    "(;GM[1]FF[4]CA[UTF-8]AP[CGoban:3]ST[2]" +
    "RU[Japanese]SZ[19]KM[0.00]" +
    "SO[https://gogameguru.com/]AW[cl][dl][el][bm][fm][gm][bn][gn][do][eo][go][dp][gp][bq][fq][br][cr][dr][er][fr]AB[dm][em][cn][fn][bo][co][fo][bp][ep][fp][cq][dq][eq]C[Black to play." +
    "https://gogameguru.com/]" +
    "(;B[dn]LB[en:A][cp:B]C[Correct. Now Black's alive in seki. If White tries to play A or B, Black can capture and make two eyes.])" +
    "(;B[cm]" +
